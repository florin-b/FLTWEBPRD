...
<script type="text/javascript" src="../scripts/avarieMasina.js"></script>
			...
			<td style="width: 80%;">
				<div id="contentdiv">
					...
					<table border='0'>
						...
						<tr align='center'>
							<td colspan='4'><b>Avarie masina</b></td>
						</tr>
						<br>
						...
						<tr>
							<td valign="top" colspan='4'>
								<br>
								<div id="listRezultat"></div>
							</td>
						</tr>

						<tr>
							<td valign="top" colspan='4'>
								<div id="tipMesaj" style="visibility: hidden">
									<br><p><b>Selectati mesajul pentru expediere:</b></p>
									<jsp:include page='listMesajAlert.jsp' />
									<button type="submit" id="sendSms" class="styled-button-1">Trimite mesajul</button>
								</div>
							</td>
						</tr>
						...
						<tr>
							<td valign="top" colspan='4'>
							<br>
								<button type="submit" id="showPosition" class="styled-button-1" style="visibility: hidden">Pozitioneaza masina pe harta</button>
							</td>
						</tr>
						<tr>
							<td colspan='4'>
