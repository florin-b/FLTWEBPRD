...
<script type="text/javascript" src="../scripts/validators/moment.js"></script>
			...
			<td style="width: 80%;">
				<div id="contentdiv">
					...
					<table border='0'>
						...
						<tr align='center'>
							<td colspan='4'><b>Traseu masina</b></td>
						</tr>
						<br>
						...
						<tr id='optionsRow'>
							...
							<td valign="top" class="block_large">Interval<br> <br>
								<div id="intervalDiv" style="visibility: hidden">
									...
									<p>
										Stop: <input type="text" id="datepickerStop" size="13"> <input type="text" id="timepickerStop" class="timepickerStop" size="13" />
									</p>
									<p>
										<button type="submit" id="showTraseu" class="styled-button-1">Traseu</button>
									</p>
								</div>
							</td>
