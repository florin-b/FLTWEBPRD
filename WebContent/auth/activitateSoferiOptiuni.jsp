...
<script type="text/javascript" src="../scripts/activitateSoferi.js"></script>
			...
			<td style="width: 80%;">
				<div id="contentdiv">
					...
					<table border='0'>
						...
						<tr align='center'>
							<td colspan='4'><b>Activitate sofer</b></td>
						</tr>
						<br>
						...
						<tr id='optionsRow'>
							...
							<td valign="top" class="option_block">Interval<br> <br>
								<div id="intervalDiv" style="visibility: hidden">
									<p>
										Start: <input type="text" id="datepickerStart">
									</p>
									<p>
										Stop: <input type="text" id="datepickerStop">
									</p>
									<p>
										<button type="submit" id="showDocumente" class="styled-button-1">Documente</button>
									</p>
								</div>
							</td>
							<td valign="top" class="option_block">Document<br> <br>
								<div id="block_documente" style="visibility: hidden">
									<div id="listDocumente"></div>
									<br>
									<button type="submit" id="showActivitate" class="styled-button-1">Activitate</button>
								</div>
							</td>
						...
						<tr>
							...
							<td colspan='3' valign="center" align="left"><div id='selectedOptions' style='visibility: invisible' class="info"></div></td>
