...
public class OperatiiSms implements IOperatiiSms {
	...
	public List<BeanSmsEmis> getSmsEmis(String dataSms, String filiala) throws SQLException {
		...
		String sqlString = " select a.codsofer, a.document, a.client, a.data, a.ora, b.dataexp, b.oraexp from sapprd.zevenimentsofer a, sapprd.zsmsclienti b "
				+ " where a.data =? and b.borderou = a.document and b.codadresa = a.codadresa order by a.data, a.ora ";
