...
public class Client {
	...
	public String toString() {
		return "Client [poz=" + poz + ", codClient=" + codClient + ", numeClient=" + numeClient + ", tipClient=" + tipClient + ", codAdresa=" + codAdresa
				+ ", isStartBord=" + isStartBord + ", isStopBord=" + isStopBord + ", localitate=" + localitate + ", strada=" + strada + ", nrStrada=" + nrStrada
				+ ", codJudet=" + codJudet + "]";
	}
