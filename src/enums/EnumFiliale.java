...
public enum EnumFiliale {
	...
	ARGES("Arges", "AG10"), ANDRONACHE("Andronache", "BU13"), BACAU("Bacau", "BC10"), BIHOR("Bihor", "BH10"), BUZAU("Buzau", "BZ10"), GLINA("Glina", "BU10"), MILITARI(
			...
			"DJ10"), GALATI("Galati", "GL10"), GALATI_CENTRAL("Galati central", "GL90"), HUNEDOARA("Hunedoara", "HD10"), IASI("Iasi", "IS10"), MARAMURES(
			"Maramures", "MM10"), MURES("Mures", "MS10"), PIATRA_NEAMT("Neamt", "NT10"), PRAHOVA("Prahova", "PH10"), TIMISOARA("Timisoara", "TM10"), VRANCEA(
			"Vrancea", "VN10");
